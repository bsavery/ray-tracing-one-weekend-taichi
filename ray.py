...
class Rays:
    def __init__(self, x, y):
        ...
        ti.root.dense(ti.ij, (x, y)).place(self.origin, self.direction, self.depth, self.attenuation)
    ...
    @ti.func
    def get(self, x, y):
        return self.origin[x, y], self.direction[x, y], self.depth[x, y], self.attenuation[x, y]
...
class HitRecord:
    def __init__(self, x, y):
        ...
        ti.root.dense(ti.ij, (x, y)).place(self.hit, self.p, self.n, self.front_facing, self.mat_index)
    ...
    @ti.func
    def get(self, x, y):
        return self.hit[x, y], self.p[x, y], self.n[x, y], self.front_facing[x, y], self.mat_index[x, y]
